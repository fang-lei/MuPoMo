...
# two-population.R ------------------------------------------------------------------------------ Description: Estimate and
# forecast mortality rates based on a semi-parametric approach, which applies parametric modelling for multiple nonparametric
# curves with the shape-related nonlinear variation.  Use China and Japan to demonstrate two-country case.
# ------------------------------------------------------------------------------ Keywords: nonparametric smoothing, parametric
# modeling, Lee-Carter method, mortality, China, Japan
# ------------------------------------------------------------------------------ See also: multipop.R
# ------------------------------------------------------------------------------ Author: Lei Fang
# ------------------------------------------------------------------------------

setwd("/Users/lei.fang/Desktop/MuPoMo")
...
# read data and compute kt based on Lee-Carter Model source('data.R')
load("~/Desktop/MuPoMo/data.RData")
...
lines(t2 + 20, sm.kt2, lwd = 4, lty = 2)
...
plot(t2, sm.kt2, type = "l", col = "blue", lwd = 4, xlab = "Time", ylab = "Kt")
lines(t1, sm.kt1, lwd = 4)
lines(t2 + 23, sm.kt2, lwd = 4, lty = 4, col = "blue")
# vertical shift
plot(t2, sm.kt2, type = "l", col = "blue", lwd = 4, xlab = "Time", ylab = "Kt")
lines(t1, sm.kt1, lwd = 4)
lines(t2, sm.kt2 + 85, lwd = 4, lty = 4, col = "blue")
...
vtheta2 = seq(-30, 10, len = 100)
vtheta4 = seq(0, 100, len = 100)
npar = length(vtheta2)
