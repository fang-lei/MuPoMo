...
# data.R ------------------------------------------------------------------------------ Description: Read data from Human
# Mortality Database and calculate kt.  ------------------------------------------------------------------------------ Keywords:
# Human Mortality Database, mortality, Lee-Carter method, multi-populations
# ------------------------------------------------------------------------------ See also: twopop.R, multipop.R, optimization.R,
# referencecurve.R, normalization.R ------------------------------------------------------------------------------ Author: Lei
# Fang ------------------------------------------------------------------------------


## read data sets China mortality data
